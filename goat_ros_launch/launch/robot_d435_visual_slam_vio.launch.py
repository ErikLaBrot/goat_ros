"""Launch GOAT robot bringup with D435 Visual SLAM and ESC IMU fusion."""
...
def generate_launch_description():
    """Build the launch description for robot bringup with visual-inertial SLAM."""
